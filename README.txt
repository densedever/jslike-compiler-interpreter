+-------------------------+
|-JS-language-Interpreter-|
+-------------------------+

Main author: densedever

This is an interpreter for a language similar to JavaScript, written in C++.

JavaScript Compiler

Goal: to make a JS compiler for desktop applications and general programming, as opposed to only making web apps. IronJS is an ECMAScript implementation that runs on the .NET framework, but I want something that compiles to native code and actually addresses and fixes the problems that the JavaScript language itself has.
...
https://www.youtube.com/watch?v=h7GQzQYBW1A&list=PLDAE55AEE0731D729
